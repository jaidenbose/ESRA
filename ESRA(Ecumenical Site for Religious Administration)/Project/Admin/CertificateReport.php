...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">CERTIFICATE REPORT</h1>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
            <?php 
	$selQ="select * from tb_certificate f inner join tb_family s on s.fam_id=f.fam_id inner join tbl_certificatetype p  on f.certificatetype_id=p.certificatetype_id " ;
	$i=0;
	$row=$conn->query($selQ);
