...
$dname = "";
	...
	move_uploaded_file($temp,"../Assets/Famphoto/".$image);
			...
			$ins = "insert into tb_news(news_date, news_content,news_image) values('".$date."','".$content."','".$image."')";
	...
	if(isset($_GET['id']))
	{
		$del = "delete from tb_news where news_id = '".$_GET['id']."'";
		if($conn->query($del))
		{
                                    ...
                                    <div class="col-lg-12">
                                        <div class="white_box mb_30">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label for="txt_date">Content</label>
                                    ...
                                    <table class="table lms_table_active">
                                        <thead>
                                            <tr style="background-color: #74CBF9">
                                                ...
                                                <td align="center" scope="col">News Date</td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?php echo $data["news_date"];?></td>
                                                <td align="center"><?php echo $data["news_content"];?></td>
                                                <td align="center"><a href="News.php?id=<?php echo $data["news_id"];?>" class="status_btn">Delete</a> &nbsp;&nbsp;&nbsp;&nbsp;
</td>                                            </tr>
                                            <?php                    
                                              }
