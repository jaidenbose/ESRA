...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">SERVICE REPORT</h1>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
            <?php 
	$selQ="select * from tb_service f inner join tb_priest p  on f.priest_id=p.priest_id inner join tb_family s on f.fam_id=s.fam_id inner join tb_servicetype j on f.servicetype_id=j.servicetype_id ";
	$i=0;
	$row=$conn->query($selQ);
