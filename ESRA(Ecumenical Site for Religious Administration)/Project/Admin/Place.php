...
if(isset($_POST['btn_save']))
	{
		...
		$district = $_POST['sel_district'];
			...
			$ins = "insert into tb_place (place_name,district_id) values('".$place."','".$district."')";
	...
	if(isset($_GET['id']))
	{
		$del = "delete from tb_place where place_id = '".$_GET['id']."'";
		if($conn->query($del))
		{
			header("location:Place.php");
		}
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php
	$i=0;
	  $sel = "select * from tb_place p inner join tb_district d on d.district_id=p.district_id";
	  $row = $conn->query($sel);
	  while($data = $row->fetch_assoc())
	  {
		  $i++;
