...
<html lang="en">
	...
	<body>
		<div class="site-content">
			<header class="site-header">
				<div class="container">
					<a href="../" class="branding">
						<img src="../Assets/Template/Main/logo.png" alt="" class="logo">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							<li class="menu-item current-menu-item"><a href="Priesthomepage.php">Homepage</a></li>
                            <li class="menu-item current-menu-item"><a href="Viewprofilep.php">Profile</a></li>
                            <li class="menu-item current-menu-item"><a href="Editprofilep.php">Edit Profile</a></li>
                            <li class="menu-item current-menu-item"><a href="Passchangep.php">Change Password</a></li>
                            <li class="menu-item current-menu-item"><a href="ViewDirectory.php">Directory</a></li>
                            <li class="menu-item current-menu-item"><a href="ViewServiceBooking.php">Bookings</a></li>
							...
							<li class="menu-item"><a href="../Assets/Template/Main/seremons.html">Seremons <small>Laboris nisi aliquip</small></a></li>
							<li class="menu-item"><a href="../Assets/Template/Main/events.html">Events <small>Sunt in culpa</small></a></li>
							<li class="menu-item"><a href="../Assets/Template/Main/families.html">Families <small>Aute irure</small></a></li>
			...
			</header> <!-- .site-header --><br><br><br><br><br><br>