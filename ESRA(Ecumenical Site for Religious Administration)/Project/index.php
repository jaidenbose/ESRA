			...
			<header class="site-header">
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							<li class="menu-item current-menu-item"><a href="index.php">Homepage</a></li>
                            <li class="menu-item current-menu-item"><a href="Guest/ChurchGalleryImages.php">Gallery</a></li>
                            <li class="menu-item current-menu-item"><a href="Guest/FamilyRegistration.php">Sign Up</a></li>
                            <li class="menu-item current-menu-item"><a href="Guest/login.php">Login</a></li>
